    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="sm" aria-label={t("nav.language")}>
          ...
          <span className="hidden sm:inline">{currentMeta?.emoji} {currentMeta?.nativeName}</span>
          <span className="sm:hidden">{currentMeta?.emoji}</span>
        </Button>
      </DropdownMenuTrigger>
